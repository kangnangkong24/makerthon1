...
class _FirstScreenState extends State<FirstScreen> {
  ...
  void initState() {
    ...
    database.child('toilet/1floor').onValue.listen((eventToilet) {
    ...
    database.child('tissue/1floor').onValue.listen((eventTissue) {
    ...
    database.child('paper/1floor').onValue.listen((eventTissue) {
      final dataMap = eventTissue.snapshot.value as Map;
    ...
    database.child('trash/1floor').onValue.listen((eventTissue) {
      final dataMap = eventTissue.snapshot.value as Map;
