...
class _ThirdScreenState extends State<ThirdScreen> {
  ...
  void initState() {
    ...
    database.child('toilet/3floor').onValue.listen((eventToilet) {
    ...
    database.child('tissue/3floor').onValue.listen((eventTissue) {
    ...
    database.child('paper/3floor').onValue.listen((eventTissue) {
      final dataMap = eventTissue.snapshot.value as Map;
    ...
    database.child('trash/3floor').onValue.listen((eventTissue) {
      final dataMap = eventTissue.snapshot.value as Map;
