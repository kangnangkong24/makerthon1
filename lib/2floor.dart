...
class _SecondScreenState extends State<SecondScreen> {
  ...
  void initState() {
    ...
    database.child('toilet/2floor').onValue.listen((eventToilet) {
    ...
    database.child('tissue/2floor').onValue.listen((eventTissue) {
    ...
    database.child('paper/2floor').onValue.listen((eventTissue) {
      final dataMap = eventTissue.snapshot.value as Map;
    ...
    database.child('trash/2floor').onValue.listen((eventTissue) {
      final dataMap = eventTissue.snapshot.value as Map;
